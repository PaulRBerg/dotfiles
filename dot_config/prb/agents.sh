...
alias c_5l="codex -m $CODEX_MODEL -c model_reasoning_effort=low"
alias c_5m="codex -m $CODEX_MODEL -c model_reasoning_effort=medium"
alias c_5h="codex -m $CODEX_MODEL -c model_reasoning_effort=high"
alias c_5h="codex -m $CODEX_MODEL -c model_reasoning_effort=xhigh"
alias cda="cd ~/.agents"
