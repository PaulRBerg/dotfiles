...
# Enable the over-the-top focus ring animation
...
# Disable press-and-hold for VSCode and Cursor (enables key repeat)
...
defaults write NSGlobalDomain AppleLanguages -array "en" "ro" "ru" "zh-Hans"
...
# Sleep
sudo pmset -c displaysleep 15 # on charger
sudo pmset -b displaysleep 3  # on battery: display < system (5 min)
...
# Set the animation when hiding/showing the Dock to 0.4
...
# Expand save/open panels by default
defaults write com.google.Chrome NSNavPanelExpandedStateForSaveMode -bool true
defaults write com.google.Chrome NSNavPanelExpandedStateForOpenMode -bool true
...
# Expand save/open panels by default
defaults write company.thebrowser.Arc NSNavPanelExpandedStateForSaveMode -bool true
defaults write company.thebrowser.Arc NSNavPanelExpandedStateForOpenMode -bool true
...
echo ""
echo "🎉 macOS configuration complete!" >&2
echo ""
